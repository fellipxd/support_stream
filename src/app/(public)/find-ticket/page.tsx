  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-14 sm:px-6">
      <div className="rounded-xl border border-slate-200 bg-white p-6 sm:p-8">
        <h1 className="text-xl font-bold text-slate-900">Looking for a ticket you reported?</h1>
        ...
        <div className="mt-6 space-y-4 text-sm text-slate-600">
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
            <h2 className="font-semibold text-slate-900">If you reported as a guest</h2>
            <p className="mt-1">
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
            <h2 className="font-semibold text-slate-900">If you have an account</h2>
